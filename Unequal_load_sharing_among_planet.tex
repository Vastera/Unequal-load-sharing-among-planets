...
\nomenclature{\(R_{\{\cdot\}}\)}{gear pitch circle radius}
\nomenclature{\(T_{\rm s}\)}{total torque applied on input sun gear}
\nomenclature{$M$}{planet number}
\nomenclature{$\sigma_{{\rm r}i},\sigma_i$}{transfer path effect on planet-ring gear}
\nomenclature{$\sigma_{{\rm s}i}$}{transfer path effect on planet-sun gear}
\nomenclature{$\xi_{{\rm r}i},\xi_{{\rm s}i}$}{vibration originating from the $i$-th planet-ring and planet-sun gears}
\nomenclature{$\Theta_i$}{nominal angular position of $i$-th planet}
\nomenclature{$\epsilon_i$}{angular position error of $i$-th planet center}
\nomenclature{$e_i$}{tangential error of $i$-th planet center}
\nomenclature{$\operatorname{III}(t)$}{Dirac comb function}
\nomenclature{$\{\cdot\}_{\rm r}$, $\{\cdot\}_{\rm p}$, $\{\cdot\}_{\rm s}$, $\{\cdot\}_{\rm c}$}{ring gear, planet, sun gears and carrier, respectively}
\nomenclature{$Z_{\{\cdot\}}$}{gear tooth number}
...
\nomenclature{$F$}{strength factor of transfer path effect}
\nomenclature{$a$}{attenuation factor of transfer path effect}
\nomenclature{$\beta$}{structural damping coefficient}
...
\nomenclature{$\delta(t)$}{Dirac impulse}
...
\end{figure}
%\par The extra sidebands at non M multiples of carrier orders can be partially attributed by the phase modulation effect (with a period of carrier rotation period and fluctuates at each planet position (both time and space)).
